...
EACH session in R. Just beause you had tidyverse loaded last time means very little until you load it for the current session.
...
A no-show appointment occurs when a patient makes a doctor
appointment, receives all of the instructions, and does not come to
